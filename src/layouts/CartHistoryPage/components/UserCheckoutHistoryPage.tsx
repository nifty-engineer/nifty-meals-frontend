...
import UserCheckoutHistoryModel from "../../../models/UserCheckoutHistoryModel";
import { Pagination } from "../../Utils/Pagination";
import { SpinnerLoading } from "../../Utils/SpinnerLoading";

export const UserCheckoutHistoryPage = () => {
  const { authState, isAuthenticated } = useAuth();
  const [isLoadingHistory, setIsLoadingHistory] = useState(true);
  const [httpError, setHttpError] = useState(null);

  // User Checkout History
  const [histories, setHistories] = useState<UserCheckoutHistoryModel[]>([]);
  ...
  useEffect(() => {
    const fetchUserHistory = async () => {
      if (authState && isAuthenticated) {
        ...
        setHistories(historyResponseJson._embedded.userCheckoutHistories);
